...
<c:if test="${alertMsg}">
 ...
 <a href="${pageContext.servletContext.contextPath}/admin/adminhome"> <button class="tablinks" onclick="openCity(event, 'MyProfile')">MyProfile</button></a>
  <a href="${pageContext.servletContext.contextPath}/customer/allCustomers"><button class="tablinks2  active " onclick="openCity(event, 'MyProfile')" >Customers</button></a>
  ...
  <a href="${pageContext.servletContext.contextPath}/doctor/doctorList"><button class="tablinks" onclick="openCity(event, '')" >Doctors</button></a>
    ...
    <c:param name="id" value="${tempservice.id}"/>
    </c:url>
    ...
    <c:param name="id" value="${tempservice.id}"/>
     ...
     <tr>
      ...
      <td >${tempservice.first_name} ${tempservice.last_name}</td>
